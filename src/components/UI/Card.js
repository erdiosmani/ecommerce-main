...
function Card({ details, setCartItems, showModalHandler,setSelectedItem }) {


  const onIconClick = () => {
    showModalHandler();
    setTimeout(() => setSelectedItem(details), 500);
  };

  return (
    <div>
      <div class="max-w-md w-11/12 bg-gray-900 shadow-lg rounded-xl p-6 mt-5">
        <div class="flex flex-col ">
          <div class="">
            <div class="relative h-62 w-full mb-3 ">
              <div class="absolute flex flex-col top-0 right-0 p-3 opacity-30 ">
              ...
              <img
                src={details.image}
                alt="Just a flower"
                class=" w-full   object-fill  rounded-2xl shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)]"
              />
            </div>
      ...
      {/* <div class="flex justify-center">
        <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
          ...
          <div class="p-6 flex flex-col justify-start">
            <h5 class="text-gray-900 text-xl font-medium mb-2">{details.title}</h5>
